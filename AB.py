...
if __name__ == "__main__":
    ...
    # Peaborm 10 fold cross validation
    kfold = model_selection.KFold(n_splits=10)
    results = model_selection.cross_val_score(ab, X_train, y_train, cv=kfold, verbose=2, n_jobs=2)
    ...
    # Save the model
    with open('data/ab.model', 'wb') as handle:
        pickle.dump(ab, handle, protocol=pickle.HIGHEST_PROTOCOL)
